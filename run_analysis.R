...
##Correct activity_labels , feature and subject tables
...
##Label Y_train and Y_test with activity labels
...
###############################################################################
###Label X_test and X_train column name which measurements on mean and S.D ##
 featuresmean<-grep("mean",features[,2])
 featuresSD<-grep("std",features[,2])

 ###Rename X_train columns
...
###Merge Test table with Train table ## row bind
